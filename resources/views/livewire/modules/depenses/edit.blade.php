            ...
            <form role="form" wire:submit.prevent="updateDepense()">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('editDepense.categories_recettes_id') is-invalid @enderror"
                            name="editDepense.categories_recettes_id" wire:model="editDepense.categories_recettes_id">
                            <option value="">---------</option>
                            @foreach($categories as $value)
                            <option value="{{ $value->id }}">{{ $value->nom }}</option>
                            @endforeach
                        </select>
                        @error("editDepense.categories_recettes_id")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    @endif
