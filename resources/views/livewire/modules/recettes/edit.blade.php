            ...
            <form role="form" wire:submit.prevent="updateRecette()">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            <label>Date *</label>
                            <input autocomplete="off" type="date" wire:model="editRecette.date_recette"
                                class="form-control @error('editRecette.date_recette') is-invalid @enderror">
                    
                            @error("editRecette.date_recette")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
