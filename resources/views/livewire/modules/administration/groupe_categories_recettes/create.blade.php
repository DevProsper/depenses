                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        <div class="form-group flex-grow-1 mr-2">
                            <label>Nom</label>
                            <input autocomplete="off" type="text" wire:model="newCategoriesRecettes.nom"
                                class="form-control @error('newCategoriesRecettes.nom') is-invalid @enderror">

                            @error("newCategoriesRecettes.nom")
